...
## 📋 Not Started
- Feature implementation (auth → home → listings → cart → checkout → orders → admin)
- Firestore security rules (Doc 9)
- Cloud Functions (Doc 8)
- Testing setup (Doc 10)
- Deployment prep (Doc 11)
- Final docs/README/case study (Doc 12)
