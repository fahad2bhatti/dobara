...
/// Temporary mock data so the Home screen has something to render
/// before listings come from Firestore. Delete once real listings
/// data (features/listings) is wired up.
final List<Product> mockProducts = [
  ...
  Product(
    ...
    city: 'Islamabad',
    description:
        "Classic vintage-wash trucker jacket. Light wear on elbows.",
    seller: const Seller(
      name: 'Zara M.',
      trustScore: 4.5,
      completedSales: 8,
